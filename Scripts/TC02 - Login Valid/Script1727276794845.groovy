...
WebUI.navigateToUrl('http://saucedemo.com/')
...
WebUI.waitForElementPresent(findTestObject('Page_Swag Labs/div_Swag Labs'), 4)

WebUI.verifyElementPresent(findTestObject('Page_Swag Labs/div_Swag Labs'), 2)
